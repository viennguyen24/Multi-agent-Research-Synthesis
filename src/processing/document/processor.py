...
from .backends import ChandraOCRBackend, DoclingBackend, LightOnOCRBackend, GLMOCRBackend
...
def get_ocr_backend(name: str = "glm") -> OCRBackend:
...
class DocProcessor:
    def __init__(self, backend: str | OCRBackend = "glm"):
